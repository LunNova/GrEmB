		...
		function addSBConf(){
			...
			if(superBundlePrefs){
				...
				if(currentVersion <= localVersion){
					...
					if(!((/unstable/i).test("http://nallar.me/scripts/GrEmB.user.js"))){document.getElementById('installclick3').setAttribute('href',"http://nallar.me/scripts/GrEmB.user.js");}
				}else{
					if(!((/unstable/i).test("http://nallar.me/scripts/GrEmB.user.js"))){document.getElementById('installclick2').setAttribute('href',"http://nallar.me/scripts/GrEmB.user.js");}
				}
